...
export SMTP_PASSWORD="chpczdvzeeacozpp"

# JWT Configuration (use dummy values for local dev, change for production)
export JWT_SECRET="32840c2e7f5495938afef13b7e456c5c52316ad51488289bd4a687c90ad21446"
export JWT_ALGO="HS256"
export JWT_TTL_SECONDS="604800"  # 7 days
export GOOGLE_PLACES_API="AIzaSyDv_dAGXtGgQg959t4H9a9FX1RmiXkHGpY"
export CLOUDFLARE_ACCOUNT_ID="8557e9773b5c16c07f55db5b2b6eaf75"
export CLOUDFLARE_API_TOKEN="f7mv-MzUNmJW8ZaF-edUK-SvzrIpzHCUBDIB8ti0"

# reCAPTCHA (use dummy values for local dev, get real keys from Google Console)
export RECAPTCHA_SECRET_KEY="6LdFvnUsAAAAAOymyGz07qNI4gujAOr-9pBvVxdz"
